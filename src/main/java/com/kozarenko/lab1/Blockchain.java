...
public class Blockchain {
    ...
    public static void main(String[] args) {
        ...
        Block KDO_genesisBlock = KDO_blockchain.KDO_genesisBlock();
        int KDO_nonce = KDO_blockchain.KDO_proofOfWork(KDO_genesisBlock.getKDO_Nonce());
        System.out.println("Nonce (proof): " + KDO_nonce);
        KDO_blockchain.KDO_newBlock(KDO_nonce, Blockchain.KDO_hash(KDO_genesisBlock));
        System.out.println(KDO_blockchain);
    }
}
